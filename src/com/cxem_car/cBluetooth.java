...
public class cBluetooth{
    ...
    // statuses for Handler (������� ��� Handler)
    public final static int BL_NOT_AVAILABLE = 1;        	// Bluetooth is not available (Bluetooth �� �������)
    public final static int BL_INCORRECT_ADDRESS = 2;		// incorrect MAC-address (������������ MAC-�����)
    public final static int BL_REQUEST_ENABLE = 3;			// request enable Bluetooth (������ �� ��������� Bluetooth)
    public final static int BL_SOCKET_FAILED = 4;			// socket error (������ SOCKET)
